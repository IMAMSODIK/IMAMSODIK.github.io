                        ...
                        f.find(".dd-s-b").each(function(a, e) {
                            ...
                            if (r.hasClass("dd-s-b-m") || r.hasClass("dd-s-b-d")) {
                                if (r.hasClass("dd-s-b-m"))
                                    for (var n = 12, o = t; n > o; o++) r.find("ul").append('<li data-id="' + (o + 1) + '">' + y[o].substr(0, 3) + "<span>" + m(o + 1) + "</span></li>");
                                if (r.hasClass("dd-s-b-d"))
                                    for (var n = 31, o = t; n > o; o++) r.find("ul").append('<li data-id="' + (o + 1) + '">' + m(o + 1) + "<span></span></li>")
                            }
